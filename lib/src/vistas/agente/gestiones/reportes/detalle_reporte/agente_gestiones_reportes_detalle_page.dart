...
class AgenteGestionesReportesDetallePage extends StatelessWidget {
  ReportsHasReports reportData;

  AgenteGestionesReportesDetallePage({Key key, @required this.reportData})
      : super(key: key);
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    _buildField('Tipo de Reporte:',
                        reportData.categoryReport.nameReport),
                    _buildRowField('ID:', reportData.id),
                  ],
                ),
                _buildField('Fecha de Reporte:', reportData.dateReport),

                _buildField('Nombre del Reporte:', reportData.nameReport),
                _buildField(
                    'Descripción del Reporte:', reportData.descriptionReport),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 4),
            Text(
              'ID: ${reportData.product.id ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Título de Anuncio: ${reportData.product?.nameProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Precio: ${reportData.product?.priceProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Comisión: ${reportData.product?.commissionProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Ciudad: ${reportData.product?.cityProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Dirección: ${reportData.product?.addressProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Teléfono de Referencia: ${reportData.product?.phoneProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Superficie M²: ${reportData.product?.areaProduct ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Nombre Propietario: ${reportData.product?.nameOwner ?? ""}, ${reportData.product?.lastnameOwner ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Telefono Propietario: ${reportData.product?.phoneOwner ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Correo electrónico propietario: ${reportData.product?.emailOwner ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'CI Propietario: ${reportData.product?.ciOwner ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Número de Contrato: ${reportData.product?.idContract ?? ""}',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.normal),
            ),
            SizedBox(height: 4),
            Text(
              'Descripción: ${reportData.product?.descriptionProduct ?? ""}',
              style: TextStyle(
                fontSize: 14,
