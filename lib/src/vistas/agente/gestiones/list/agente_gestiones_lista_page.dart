...
import 'agente_gestiones_lista_controlador.dart';

class AgenteGestionesListPage extends StatefulWidget {
  Order order;
  AgenteGestionesListPage({Key key, @required this.order}) : super(key: key);

  @override
  State<AgenteGestionesListPage> createState() =>
      _AgenteGestionesListPageState();
}

class _AgenteGestionesListPageState extends State<AgenteGestionesListPage> {
  AgenteGestionesListController _controlador =
      new AgenteGestionesListController();
