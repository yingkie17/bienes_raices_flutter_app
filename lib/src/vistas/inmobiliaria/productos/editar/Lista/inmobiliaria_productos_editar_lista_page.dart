...
import 'package:bienes_raices_app/src/vistas/inmobiliaria/productos/editar/Lista/inmobiliaria_producto_editar_lista_controlador.dart';
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';

class InmobiliariaProductosEditarListaPage extends StatefulWidget {
  const InmobiliariaProductosEditarListaPage({Key key}) : super(key: key);

  @override
  State<InmobiliariaProductosEditarListaPage> createState() =>
      _InmobiliariaProductosEditarListaPageState();
}

class _InmobiliariaProductosEditarListaPageState
    extends State<InmobiliariaProductosEditarListaPage> {
  InmobiliariaProductosEditarListaController _controlador =
      new InmobiliariaProductosEditarListaController();
