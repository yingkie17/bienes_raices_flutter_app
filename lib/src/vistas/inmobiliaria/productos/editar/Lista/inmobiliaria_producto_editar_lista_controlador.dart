...
import 'package:bienes_raices_app/src/vistas/inmobiliaria/productos/editar/detalle/inmobiliaria_producto_editar_detalle_page.dart';
import 'package:flutter/material.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class InmobiliariaProductosEditarListaController {
  ...
  void openBottomSheet(Product product) {
    showMaterialModalBottomSheet(
        context: context,
        builder: (context) => InmobiliariaProductosEditarDetallePage(
