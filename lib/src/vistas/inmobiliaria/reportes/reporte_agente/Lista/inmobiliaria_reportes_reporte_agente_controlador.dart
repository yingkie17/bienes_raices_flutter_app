...
class InmobiliariaReportesAgenteListaController {
...
//Metodo para Generar Reporte
  ...
  void generarReporte() async {
    ...
    if (selected_id_agent == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          behavior: SnackBarBehavior.floating,
          backgroundColor: Colors.red[600],
          content: Text('No seleccionó el agente .'),
        ),
      );
      return;
    }
    ...
    String getAgentReport = '$selected_id_agent/$selectedReportId/$periodo';
    print('Prueba de ruta de reportes ${getAgentReport}');
