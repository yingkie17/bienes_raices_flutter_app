...
import 'cliente_ordenes_lista_controlador.dart';

class ClienteOrdenesListPage extends StatefulWidget {
  Order order;
  ClienteOrdenesListPage({Key key, @required this.order}) : super(key: key);

  @override
  State<ClienteOrdenesListPage> createState() => _ClienteOrdenesListPageState();
}

class _ClienteOrdenesListPageState extends State<ClienteOrdenesListPage> {
  ClienteOrdenesListController _controlador =
      new ClienteOrdenesListController();
            ...
            leading: IconButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context,
                    'cliente/propiedades/list'); // Esto hará que la aplicación vaya hacia atrás
              },
            ),
            title: Text(
              'Mis Tickes Generados',
              style: TextStyle(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      width: double.infinity,
                      child: Text(
                        'Agente: ${order.agent?.name ?? 'No asignado'} ${order.agent?.lastname ?? ''}',
                        style:
                            TextStyle(fontSize: 14, fontFamily: 'NimbusSans'),
                        maxLines: 1,
                      ),
